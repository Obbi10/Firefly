...
function HomeIcon({ active }) {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill={active ? '#60a5fa' : 'none'} stroke={active ? '#60a5fa' : '#4b5563'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
function TimerIcon({ active }) {
  return (
    <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#60a5fa' : '#4b5563'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
